    ...
    define('KISSIT_MAIN_PRODUCT_WATERMARK_MIN_IMAGE_HEIGHT', '60');
		tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title,configuration_key,configuration_value,configuration_description,configuration_group_id,sort_order,date_added, set_function) VALUES 
			...
			('KissIT min image height to apply Watermark', 'KISSIT_MAIN_PRODUCT_WATERMARK_MIN_IMAGE_HEIGHT', '" . tep_db_input(KISSIT_MAIN_PRODUCT_WATERMARK_MIN_IMAGE_HEIGHT) . "', 'The minimum height of thumbnail images to apply the watermark.<br /><br />', '4', '27', NOW(), null)
				");
		tep_db_query("UPDATE `" . TABLE_CONFIGURATION . "` SET `configuration_value`='14'  WHERE configuration_key= 'KISSIT_IMAGE_MODULE';");
  }

	if ( KISSIT_IMAGE_MODULE < 17) {
		tep_db_query("INSERT INTO " . TABLE_CONFIGURATION . " (configuration_title,configuration_key,configuration_value,configuration_description,configuration_group_id,sort_order,date_added, use_function, set_function) VALUES 
			('KissIT Reset thumbs', 'KISSIT_RESET_IMAGE_THUMBS', 'false', 'Reset thumbs cache.', '4', '28', NOW(), 'tep_cfg_reset_thumbs_cache', '" . tep_db_input("tep_cfg_select_option(array('reset', 'false'), ") . "')
				");
  		tep_db_query("UPDATE `" . TABLE_CONFIGURATION . "` SET `configuration_value`='17'  WHERE configuration_key= 'KISSIT_IMAGE_MODULE';");
  }
