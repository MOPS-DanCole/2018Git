...
*/
  ...
  class tp_email_anniversary {
    var $group = 'email_anniversary';
    var $template = '';
    var $title = 'Anniversary Template';
    var $description = 'osCommerce Basic Anniversary Template Node with welcome text';
