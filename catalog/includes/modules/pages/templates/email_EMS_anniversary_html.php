                ...
                <td align="center" valign="top" style="padding-bottom:0px;">
                  ...
                  <table id="emailBody" border="0" cellpadding="0" cellspacing="0" width="100%" style="background-color:#FFFFFF; border-collapse:separate !important; border-radius:4px;">
                    <tr>
					  ...
					  <p align="center"><a href="http://www.aquariumsupplies.ca/aquarium"><img align="right" border="0" hspace="0" src="http://www.aquariumsupplies.ca/aquarium/newsletter/images/Happy_Anniversary.jpg" vspace="0" /></a></p>
						...
						<p>It was <?php echo $anniversary_date; ?> -- <?php echo $years; ?> <?php echo $years_past; ?> ago. Can you believe it? You placed your first order with us that day.<br />
						<p>To recognize this special occasion and thank you for your business, we have prepared a special Customer Exclusive &quot;ANNIVERSARY&quot; coupon. This coupon will enable you to take 10% off the price of any items that you purchase from us in the next 30 days.</p>
						<p>This is our way of saying THANK-YOU for your business during the past <?php echo $years_number; ?> <?php echo $years_past; ?>!!</p>
						<p>We really do appreciate having you as a customer and hope you can take advantage of this Customer Exclusive discount.</p>
