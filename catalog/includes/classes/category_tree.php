 ...
 */
  ...
  class category_tree {
    ...
    var $root_category_id = 1,  // was set to 0, 125 is Reptile, Industrial is 431, Aquarium is 1, Pond is 173
        $max_level = 0,
        $root_start_string = '',
        $root_end_string = '',
        $parent_start_string = '',
