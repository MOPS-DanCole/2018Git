...
// define the filenames used in the project
  ...
  define('FILENAME_CUSTOMER_FEEDBACK', 'customer_feedback.php');
  ...
  define('FILENAME_NEWSLETTER_SUBSCRIPTIONS_THANK_YOU', 'newsletter_subscriptions_thank_you.php');	
  ...
  define('FILENAME_POPUP_DROPSHIP_OR_SPECIAL_ORDER_HELP', 'popup_dropship_or_special_order_help.php');
?>
