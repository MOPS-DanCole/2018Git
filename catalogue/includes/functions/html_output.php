...
// Output a jQuery UI Button
  function tep_draw_button($title = null, $icon = null, $link = null, $priority = null, $params = null, $style = null, $tooltip = null ) {
    ...
    if ( ($params['type'] == 'button') && isset($link) ) {
	 ...
	 $button .= '<a';
	 $button .= (isset($tooltip)) ? ' title="' . $tooltip . '"' : '';
     $button .= ' id="btn' . $button_counter . '" href="' . $link . '"';
  ...
  // function for custom category lists
