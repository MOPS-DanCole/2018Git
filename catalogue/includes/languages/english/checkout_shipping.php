...
define('TEXT_CHOOSE_SHIPPING_DESTINATION', 'Please choose from your address book where you would like the items to be delivered to.<br><br>');
define('TITLE_SHIPPING_ADDRESS', 'Shipping Address:');

define('TABLE_HEADING_SHIPPING_METHOD', 'Shipping Method');
//define('TEXT_CHOOSE_SHIPPING_METHOD', 'Please select your preferred method for shipping.    <b><br><br><font color="RED">PLEASE NOTE:  If you select Canada Post be aware that there is the possibility of a Mail Distruption as early as July 2nd.</font></b>');
define('TEXT_CHOOSE_SHIPPING_METHOD', 'Please select your preferred method for shipping.');
