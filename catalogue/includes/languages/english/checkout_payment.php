...
define('TEXT_SELECTED_BILLING_DESTINATION', 'Please choose from your address book where you would like the invoice to be sent to.<br><br>');
...
define('TABLE_HEADING_DISCOUNT_COUPON', '<br>Customer Exclusive Discounts');
define('TEXT_ENTER_DISCOUNT_COUPON_INFORMATION', 'If you have a Customer Exclusive coupon, please enter it below:<br><br>');
