...
*/
  ...
  define('MODULE_CONTENT_FOOTER_INFORMATION_SHIPPING', 'Shipping Information');
  define('MODULE_CONTENT_FOOTER_INFORMATION_PRIVACY', 'Privacy Notice');
  define('MODULE_CONTENT_FOOTER_INFORMATION_CONDITIONS', 'Questions');
  define('MODULE_CONTENT_FOOTER_INFORMATION_CONTACT', 'Contact Us');
  define('MODULE_CONTENT_FOOTER_INFORMATION_TESTIMONIALS', 'Customer Testimonials');
