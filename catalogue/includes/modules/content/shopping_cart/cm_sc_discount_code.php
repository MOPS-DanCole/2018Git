...
*/
  ...
  class cm_sc_discount_code {
      ...
      <script>
      	...
      	$(document).ready(function() {
		        ...
		        function discount_code_process() {
					...
					function(data) { data == 1 ? $("#discount_code_status").empty().append('<i class="fa fa-check fa-lg" style="color:#00b100;"></i>') : $("#discount_code_status").empty().append('<i class="fa fa-ban fa-lg" style="color:#ff2800;"></i>');
    ...
    function install() {
      ...
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, date_added) values ('Sort Order', 'MODULE_CONTENT_SC_DISCOUNT_CODE_SORT_ORDER', '600', 'Sort order of display. Lowest is displayed first.', '6', '3', now())");
   }
