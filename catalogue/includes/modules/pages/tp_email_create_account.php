...
*/
  ...
  class tp_email_create_account {
    ...
    var $description = 'New Customer - First Email<br />Preview generated from <strong>last account</strong> data';
    var $section = 'shop';
    var $version = '2.00';
    ...
    function build() {
      ...
      if ($oscTemplate->_email_data['create_account']['enable_osc_mail'] == 'True') {
        ...
        $mimemessage->send($name, $email_address, STORE_OWNER, STORE_OWNER_EMAIL_ADDRESS, EMAIL_SUBJECT);
      }
    }
